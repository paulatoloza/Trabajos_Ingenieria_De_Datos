...
describe product;
insert into product (idProducto, codigoProducto, nombreProducto, precioProducto, stock) 
values (1,'1001','mani','2000', '1');

insert into product values (2,'1001','frijol','2000', '1');
insert into product values (3,'1001','lenteja','2000', '1');
insert into product values (4,'1001','arroz','2000', '1');
insert into product values (5,'1001','arverja','2000', '1');
